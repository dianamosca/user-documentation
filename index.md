...
* `filters`: **do not edit this column** The Excel formula concatenante the value from column D to G to generate the filter expression for Unifyd. The formula is `="{"""&D2&""""&":{"&""""&"operand"""&":["""&F2&""""&","&""""&G2&""""&","""&"0"""&","""&"0"""&"],"""&"operator"""&":"""&E2&""""&"}}"`
